...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Sufi's Cafe" },
      ...
      { name: "twitter:title", content: "Sufi's Cafe — specialty coffee, matcha bar & all-day brunch" },
      { name: "description", content: "Sufi's Cafe: slow filter coffee, a ceremonial matcha bar and brunch served all day, in two warm rooms. Open daily 08:00–21:00." },
      { property: "og:description", content: "Sufi's Cafe: slow filter coffee, a ceremonial matcha bar and brunch served all day, in two warm rooms. Open daily 08:00–21:00." },
      { name: "twitter:description", content: "Sufi's Cafe: slow filter coffee, a ceremonial matcha bar and brunch served all day, in two warm rooms. Open daily 08:00–21:00." },
