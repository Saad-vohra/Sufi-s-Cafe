...
const en = {
  ...
  faq: [
    { q: "What are your hours?", a: "We are open daily, 08:00 – 21:00." },
    {
      q: "Do you take reservations?",
      a: "Yes — call us and we will hold a table.",
    },
    { q: "Is there a terrace?", a: "We have pleasant indoor seating and an outdoor terrace area." },
    { q: "Can I work from here?", a: "Mornings are quiet and seats are near power sockets." },
    { q: "Is it kid friendly?", a: "Yes — high chairs and a friendly space for families." },
  ],
};
...
const hi: typeof en = {
  ...
  allergensTitle: "एलर्जी कारक",
  noAllergens: "कोई प्रमुख एलर्जी कारक नहीं",
  protein: "प्रोटीन",
  carbs: "कार्ब्स",
  fat: "फैट",
  dietary: "आहार",
  orderAtTable: "ऑर्डर / कॉल करें",
  close: "बंद करें",
  itemsOne: "आइटम",
  itemsMany: "आइटम",
  clear: "हटाएँ",
  ...
  faq: [
    { q: "आपका समय क्या है?", a: "हम रोज़ाना 08:00 – 21:00 तक खुले रहते हैं।" },
    { q: "क्या बुकिंग होती है?", a: "जी हाँ — कॉल कीजिए, हम टेबल रोक लेंगे।" },
    { q: "क्या टेरेस है?", a: "हमारे पास आरामदायक इनडोर और आउटडोर टेरेस स्पेस है।" },
    { q: "क्या यहाँ काम कर सकते हैं?", a: "सुबह शांत रहती है और सॉकेट की सुविधा उपलब्ध है।" },
    { q: "क्या बच्चों के लिए ठीक है?", a: "जी हाँ — हाई चेयर और परिवारों के लिए अनुकूल माहौल है।" },
  ],
};
